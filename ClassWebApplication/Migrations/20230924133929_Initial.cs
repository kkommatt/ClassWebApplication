    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectorCourses", x => new { x.LectorId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_LectorCourses_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LectorCourses_Lectors_LectorId",
                        column: x => x.LectorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectorCourses_CourseId",
                table: "LectorCourses",
                column: "CourseId");
